...
1. Download [petalinux-sdimage.zip](https://unisyd-my.sharepoint.com/:u:/g/personal/philip_leong_sydney_edu_au/IQDltjYrJlWZRLTp5rjCbmF2AUcbXtBBSCw6mNhptvlMcoo?e=fbmou3), unzip and and burn the image to your card iusing Etcher.
...
![15](./image/15.png)
The user name is always **petalinux**, set your own password using the ```passwd''' command.
